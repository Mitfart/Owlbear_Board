...
- Before changing behavior, read root `CONTEXT.md` and relevant `docs/adr/`. Owlbear metadata is the source of truth; shared edits are last-write-wins and live updates use polling.
