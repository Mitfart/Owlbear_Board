...
export default function App() {
  ...
  function endTabDrag(event: React.PointerEvent<HTMLDivElement>) {
    ...
    if (moved) { suppressTabClick.current = true; window.setTimeout(() => { suppressTabClick.current = false; }); }
  }
