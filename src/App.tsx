...
export default function App() {
  ...
  async function cancelFocusedText() { editorDirty.current = false; immediateEditorSave.current = false; if (newFocusedItemId && activeBoard && !await deleteItem(newFocusedItemId)) return; setFocusedItemId(undefined); setNewFocusedItemId(undefined); setFocusDraft(""); setHasTextSelection(false); setVerticalAlignmentOpen(false); }
  ...
  function cancelFocusedImage() { editorDirty.current = false; immediateEditorSave.current = false; setImageEdit(undefined); setFocusedItemId(undefined); }
  ...
  function cancelFocusedCounter() { editorDirty.current = false; immediateEditorSave.current = false; setCounterEdit(undefined); setFocusedItemId(undefined); }

  saveFocusedEditorRef.current = (discardEmptyNewText = true) => {
